...
#define TAGKEYS(KEY,TAG) \
  ...
  { MODKEY|Mod1Mask|ShiftMask,    KEY,      tagnthmon,           {.i = TAG } },
...
//	{ MODKEY,                       XK_space,  setlayout,      {0} },
  ...
  { NULL,                         XF86XK_AudioMute, spawn,   SHCMD("dvolume.sh mute") },
  { NULL,                         XF86XK_AudioRaiseVolume, spawn, SHCMD("dvolume.sh up") },
  { NULL,                         XF86XK_AudioLowerVolume, spawn, SHCMD("dvolume.sh down") },
  ...
  { MODKEY,                       XF86XK_AudioPlay, spawn,   SHCMD("playerctl -p mpd play-pause") },
